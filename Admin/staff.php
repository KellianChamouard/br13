            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 p5">
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Le Staff</h5>
                            <p class="card-text">Vous pouvez :
                                <ul>
                                    <li>Ajouter un membre du staff</li>
                                    <li>Modifier un membre du staff</li>
                                    <li>Enlever un membre du staff</li>
                                </ul>
                    ...
                    <div class="card bg-light mb-3">
                        <div class="card-header">Ajouter un membre du staff</div>
                        <div class="card-body">
                            <form action="#">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control" id="exampleFormControlSelect1">
                                                ...
                                                <option>Enraîneur Adjoint</option>
                                                <option>Médecin</option>
                                                <option>Kiné</option>
                                                <option>Porteur d'Eau</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <a href="modif_staff.php" class="badge badge-warning text-white">Modifier</a>
